...
export default async function handler(req, res) {
  ...
  const API_KEY = process.env.GOOGLE_PICKER_API_KEY || 'AIzaSyCRiHf0k4aOMCOm9JEo1QQMI7uWzCVBBJs';
    ...
    const picker = new google.picker.PickerBuilder()
      ...
      .setCallback((data) => {
        if (data.action === google.picker.Action.PICKED) {
          ...
          showStatus('ok', '\\u2705 Zugriff erteilt f\\u00fcr: "' + folder.name + '". Du kannst dieses Fenster jetzt schlie\\u00dfen und mit /api/oauth-start fortfahren.');
